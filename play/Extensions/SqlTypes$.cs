...
namespace Abc.Extensions
{
    ...
    // Extension methods to convert native SQL server data types to CLR reference
    // types.
    public partial class SqlTypesX
    {
        ...
        public static Maybe<byte[]> ToMaybe(this SqlBytes @this)
            => @this is null || @this.IsNull ? Maybe<byte[]>.None : Maybe.Of(@this.Value);

        public static Maybe<char[]> ToMaybe(this SqlChars @this)
            => @this is null || @this.IsNull ? Maybe<char[]>.None : Maybe.Of(@this.Value);
        ...
        public static Maybe<string> ToMaybe(this SqlXml @this)
            => @this is null || @this.IsNull ? Maybe<string>.None : Maybe.Of(@this.Value);
    }
}
