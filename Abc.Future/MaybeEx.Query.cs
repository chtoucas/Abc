...
namespace Abc
{
    ...
    public partial class MaybeEx
    {
        ...
        /// </remarks>
        [Pure]
        public static Maybe<TResult> Join<TOuter, TInner, TKey, TResult>(
        ...
        [Pure]
        private static Maybe<TResult> JoinImpl<TOuter, TInner, TKey, TResult>(
            Maybe<TOuter> outer,
            Maybe<TInner> inner,
            Func<TOuter, TKey> outerKeySelector,
            Func<TInner, TKey> innerKeySelector,
            ...
            IEqualityComparer<TKey> comparer)
        {
            if (outer.TryGetValue(out TOuter x) && inner.TryGetValue(out TInner y))
            {
                ...
                {
                    return Maybe.Of(resultSelector(x, y));
                }
            }
