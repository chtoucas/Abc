...
function Invoke-Coverlet {
    ...
    $includes = "[$assembly]*"
    $excludes = "[$assembly]System.*", '[Abc.Testing]*'
    if ($IsTestProject) { $excludes += "[$assembly]*Tests", "[$assembly]AutoGeneratedProgram" }
    ...
    if ($IsTestProject) {
        # Exclude class AutoGeneratedProgram?
        # Microsoft.VisualStudio.TestPlatform.TestSDKAutoGeneratedCode
        # Use /p:GeneratedProgramFile=false? see Microsoft.NET.Test.Sdk.targets.
        $args += '/p:IncludeTestAssembly=true', 
            '/p:ExcludeByAttribute=TestSDKAutoGeneratedCode'
    }
